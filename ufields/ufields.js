        ...
        if (window.location.href.indexOf("?hp_editor") != -1 || window.location.href.indexOf("&hp_editor") != -1) {
            ...
            if ($('.hpe-logo').length) {
                $('.hpe-logo').each(function() {
                    ...
                    /*else {
                    	...
                    	$(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit Logo" href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'pform=options_systems&pkeyname=sys_option_system_id&pkey=1&x=&hpe=Y#hpe_logo\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a class="hp-help hp-tt" href="#hp_editor" title="'+ hlp + '"><i class="fa fa-question-circle" aria-hidden="true"></i><b class="hp-llable">Help</b></a></div><header class="hp-hheader">Logo</header><cpanel></cpanel><rpanel>Recommended: ' + rw + 'px</rpanel></div>');
                    }*/
                });
            }
            ...
            for (h = 1; h <= 20; h++) {
                if ($('.hpe-hl' + h).length) { // Whole Highlight area
                    $('[class*="hpe-hl' + h + ' hp-x"] .hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit Highlight ' + h + '"href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Pages&x=#hpe_hl$' + h + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div></div>');
                }
            ...
            if ($('.hpe-prev').length) { // Whole Preview area
                $('.hpe-prev.hp-x').each(function() {
                    ...
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit ' + s.replace(/@@/g, "'").replace(/_/g, " ") + '" href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Pages&x=#hpe_prev$$' + m + '&&' + s + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div></div>');
                });
            }
            ...
            if ($('.hpe-xprev').length) { // Whole Preview Area
                $('.hpe-xprev.hp-x').each(function() {
                    var m = $(this).attr('data-menu').replace(/'/g, "@@").replace(/ /g, "_");
                    var s = $(this).attr('data-submenu').replace(/'/g, "@@").replace(/ /g, "_");
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit ' + s.replace(/@@/g, "'").replace(/_/g, " ") + '" href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Pages&x=#hpe_xprev$$' + m + '&&' + s + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div></div>');
                });
            }
            ...
            if ($('.hpe-section').length) {
                $('.hpe-section.hp-x').each(function() {
                    var m = $(this).attr('data-menu').replace(/'/g, "@@").replace(/ /g, "_");
                    var s = $(this).attr('data-submenu').replace(/'/g, "@@").replace(/ /g, "_");
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Pages&x=#hpe_prev$$' + m + '&&' + s + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit ' + s.replace(/@@/g, "'").replace(/_/g, " ") + ' </a></div></div>');
                });
            }
            ...
            if ($('.hpe-old-event').length) {
                $('.hpe-old-event.hp-x').each(function() {
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Events&x=#hpe_old_event\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Events </a></div></div>');
                });
            }
            ...
            if ($('.hpe-old-directory').length) {
                $('.hpe-old-directory.hp-x').each(function() {
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=CustomersSetup&x=#hpe_old_directory\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Directory </a></div></div>');
                });
            }
            ...
            if ($('.hpe-old-classified').length) {
                $('.hpe-old-classified.hp-x').each(function() {
                    $(this).children('.hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Classifieds&x=#hpe_old_classified\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Classified </a></div></div>');
                });
            }
            ...
            if ($('.hpe-video-g-yt-url').length) {
                ...
                $('.hpe-video-g-yt-url.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Galleries&x=#hpe_video_g_yt_url$$' + vm + '&&' + vs + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Videos </a></div></div>');
            }
            ...
            if ($('.hpe-video-g-yt-code').length) {
                ...
                $('.hpe-video-g-yt-code.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Galleries&x=#hpe_video_g_yt_code$$' + vm + '&&' + vs + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Videos </a></div></div>');
            }
            ...
            if ($('.hpe-video-g-yt-id').length) { // Whole Video Area
                ...
                $('.hpe-video-g-yt-id.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Galleries&x=#hpe_video_g_yt_id$$' + vm + '&&' + vs + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Videos </a></div></div>');
            }
            ...
            if ($('.hpe-photo-g').length) { // Whole Photo Area
                ...
                $('.hpe-photo-g.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=Galleries&x=#hpe_photo_g$$' + pm + '&&' + ps + '\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Photos </a></div></div>');
            }
            ...
            if ($('.hpe-old-photog').length) {
                $('.hpe-old-photog.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + plist + 'lid=PhotoGallery&x=#hpe_old_photogx\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Photos </a></div></div>');
            }
            ...
            if ($('.hpe-contactbody').length) {
                $('.hpe-contactbody.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'pform=options_systems&pkeyname=sys_option_system_id&pkey=1&x=#hpe_contactbody\',\'iframe\');" title="Edit Contact Information"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div><header class="hp-hheader">Contact Information</header></div>');
            }
            // Copyright
            if ($('.hpe-copyright').length) {
                $('.hpe-copyright.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'pform=options_systems&pkeyname=sys_option_system_id&pkey=1&x=#hpe_copyright\',\'iframe\');" title="Edit Copyright"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div><header class="hp-hheader">Copyright</header></div>');
            }
            // Hitcounter
            if ($('.hpe-hitcounter').length) {
                $('.hpe-hitcounter.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'pform=options_systems&pkeyname=sys_option_system_id&pkey=1&x=#hpe_hitcounter\',\'iframe\');" title="Edit Hit Counter"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div><header class="hp-hheader">Hit Counter</header></div>');
            }
            // Social
            ...
            if ($('.hpe-sp').length) {
                ...
                $('.hpe-sp.hp-x .hp-y').append('<div class="hp-z"><div class="hp-span"><a href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'lid=SupportTickets&lid2=&level=1&pform=support_tickets&pkeyname=ticket_id&pkey=&fkeyname=&fkey=&eflag=Yes&wpage=&hpath=&smid=&u=&c=&lf=&x=#hpe_spackages\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div></div>');
            }
            ...
            for (ch = 1; ch <= 1000; ch++) {
                if ($('.hpe-custom-text-' + ch).length) { // TEXT
                    $('[class*="hpe-custom-text-' + ch + ' hp-x"] .hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit" href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'lid=Sections&lid2=&level=1&pform=sections&pkeyname=section_id&pkey=' + ch + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&fpx=cust_text#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div></div>');
                }
                if ($('.hpe-custom-html-' + ch).length) { // HTML
                    $('[class*="hpe-custom-html-' + ch + ' hp-x"] .hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit" href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'lid=Sections&lid2=&level=1&pform=sections&pkeyname=section_id&pkey=' + ch + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&fpx=cust_html#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div></div>');
                }
                if ($('.hpe-custom-img-' + ch).length) { // IMAGE
                    $('[class*="hpe-custom-img-' + ch + ' hp-x"] .hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit" href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'lid=Sections&lid2=&level=1&pform=sections&pkeyname=section_id&pkey=' + ch + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&fpx=cust_img#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a></div></div>');
                }
                if ($('.hpe-weather-' + ch).length) { // Weather Widget
                    var hlp = 'Provide us weather location and we will update it for you.';
                    $('[class*="hpe-weather-' + ch + ' hp-x"] .hp-y').append('<div class="hp-z"><div class="hp-span"><a title="Edit" href="#hp_editor" onclick="clearCookieLB(); OpenBLPopup(\'/' + pfist + 'lid=Sections&lid2=&level=1&pform=sections&pkeyname=section_id&pkey=' + ch + '&fkeyname=&fkey=&wpage=1&hpath=&eflag=Yes&fa=&sflag=&sortflag=&smid=&u=&c=&lf=&x=&fpx=weather#hpe_updatex\',\'iframe\');"><i class="fa fa-pencil" aria-hidden="true"></i><b class="hp-llable">Edit</b></a><a class="hp-help hp-tt" href="#hp_editor" title="' + hlp + '"><i class="fa fa-question-circle" aria-hidden="true"></i><b class="hp-llable">Help</b></a></div><header class="hp-hheader">Weather</header></div>');
                }
            }
